import  "./corporateuserchoosecountry.css" ;
import { Link } from 'react-router-dom';
import React, { useState } from 'react';
import axios from "axios";

function Corporateuserchoosecountry  () {
     ...
     const [error, setError] = useState(false);
        ...
        setSubmitted(true);
         setError(false) ;
        axios.get('http://localhost:8000/Coroporateuser/AddCountryCurrency', {
...
export default Corporateuserchoosecountry ;
