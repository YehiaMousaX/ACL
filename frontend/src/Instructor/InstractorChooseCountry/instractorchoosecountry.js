import  "./instractorchoosecountry.css" ;
import { Link } from 'react-router-dom';
import React, { useState } from 'react';
import axios from "axios";

function Instractorchoosecountry  () {
     ...
     const [error, setError] = useState(false);
        ...
        setSubmitted(true);
         setError(false) ;
        axios.get('http://localhost:8000/instractor/AddCountryCurrency', {
...
export default Instractorchoosecountry ;
